...
This archive predates the single-version branch layout and the standalone renderer.
Commands, module paths and dependency requirements here are historical, not current instructions.
Use the root README and CONTRIBUTING documents for current setup.
