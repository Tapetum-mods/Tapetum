...
val sodiumVersion = project.property("mc261_sodium") as String
...
tasks.register<JavaExec>("glRegressionTest") {
    ...
    // Optional ABI regression against a player's installed Sodium without changing dependencies.
    providers.gradleProperty("sodiumTestJar261").orNull?.let { installedJar ->
