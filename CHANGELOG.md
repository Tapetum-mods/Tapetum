...
### Exact Minecraft 26.1.1 Target

- Build this branch against Minecraft 26.1.1 and Fabric API 0.145.4 with Java 25.
- Retain independent terrain rendering and shader settings without widening version metadata.
